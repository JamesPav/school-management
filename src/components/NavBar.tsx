  ...
  return (
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="bg-white rounded-full text-xs w-7 h-7 flex items-center justify-center cursor-pointer relative">
          <Image
        ...
        <div className="flex flex-col">
          <span className="text-sm leading-3 font-medium">Jim Pav</span>
